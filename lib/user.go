...
type PfUserS struct {
	...
	IsSysadmin    bool          `label:"System Administrator" pfset:"sysadmin" pfget:"group_admin" pfskipfailperm:"yes" pfcol:"issysadmin" hint:"Whether the user is a System Administrator"`
